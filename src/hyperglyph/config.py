...
class HyperGlyphConfig:
    ...
    def __post_init__(self) -> None:
        ...
        if self.compact_tensor_codec not in {"auto", "codebook", "packed_int4", "low_rank"}:
            raise ValueError(
                "compact_tensor_codec must be 'auto', 'codebook', 'packed_int4', or 'low_rank'"
            )
